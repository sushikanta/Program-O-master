...
/***************************************
 ...
 //$url = 'http://localhost/Program-O-master/chatbot/conversation_start.php';
  /*
    ...
    <div class="centerthis">
      ...
      <div class="manspeech">
        <div  class="triangle-border bottom blue">
          <div class="botsay">Hey talk to me!</div>
        </div>
      </div>
      <div class="man"></div>
      </div>
    ...
    <div class="centerthis">
      <form method="post" name="talkform" id="talkform" action="index.php">
        <div id="chatdiv">
          ...
          <input type="hidden" name="bot_id" id="bot_id" value="1<?php //echo $bot_id;?>" />
